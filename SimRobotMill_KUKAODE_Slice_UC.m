%% Robotic Cutting Slice Simulation
...
% 2.[N] is given
N = 5000; % spindle speed of cutting tool, [scalar,rpm,modify]%%%%%%%%%%%%%【】
Ap = 1.5; % axial depth of cutting tool [scalar,mm,modify]%%%%%%%%%%%%%%%%%【】
...
% Cutting force coefficients[obj,modify]
...
for i = 1:sim_n_dt_total
    ...
    if i <= sim_n_dt_start 
        ...
        while 1
            ...
            real_2_TCP_mm = real_2_TCP_mm.* [1 -1];%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
name = ['SimRobotMill_KUKACoupleODE_Slice_',num2str(N),'rpm_',num2str(Ap),'mm.mat'];
save(name)
