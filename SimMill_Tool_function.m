function name = SimMill_Tool_function(Spindle_speed,Axial_depth)
...
% [20230321] this program is used to generated undeformed chip thickness in
% ideal situation, this data is adopted in ratio of undeformed chip
...
% 2.[N] is given
N = Spindle_speed; % spindle speed of cutting tool, [scalar,rpm,modify] %%%【】determined at 20230321
Ap = Axial_depth; % axial depth of cutting tool [scalar,mm,modify] %%%%%%%%【】determined at 20230321
...
% %% this paris used to generate data for cutting force coefficient identification.
...
name = ['D:\Reuslt\MillingCuttingForceSimulation\SimTool 20230202 formal V3\SimMill_Tool_',num2str(N),'rpm_',num2str(Ap),'mm.mat'];
save(name,'Chip_thick_T1','Chip_thick_T2','Chip_thick_T3','Chip_thick_T4')
